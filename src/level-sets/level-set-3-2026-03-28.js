...
export const LEVELS = {
    ...
    "Rook": [ // Section Rook
        ...
        "3P3P/2r2P1P/2PP4/1P3P2/2P2P2/8/8/8 b - - 0 1 (They think numbers will save them.)", // 9 (10 targets, score=80)
        "P1P1P3/r1P2P2/4P3/8/4P2P/2P4P/8/8 b - - 0 1 (Edge of the board. Tight squeeze.)", // 10 (10 targets, score=82)
        "3P4/PP6/1r6/1P6/1P6/P2P3P/P1P4P/8 b - - 0 1 (All hiding down below. Here I come!)", // 11 (11 targets, score=82)
        "5P2/3P1PP1/8/3r1P1P/PP3P2/8/6PP/8 b - - 0 1 (Two columns to clear. Focus!)", // 12 (11 targets, score=85)
        "P5P1/8/2rP4/8/8/3P1P1P/2P1P2P/3P2PP b - - 0 1 (Deep breath... here we go!)", // 13 (12 targets, score=88)
        "3P4/8/3P1P2/P5P1/P4PPr/8/8/P3P1PP b - - 0 1 (They filled the bottom rows. Rude.)", // 14 (12 targets, score=89)
        "8/4P3/1P2r3/4PP2/6P1/1P1P2P1/6P1/P3PPP1 b - - 0 1 (No room for error now.)", // 15 (13 targets, score=89)
        "3PP1PP/4P1PP/8/3r4/8/4P1P1/2PP4/3P3P b - - 0 1 (They think they can hide in a grid?)", // 16 (13 targets, score=91)
        "8/1P2P2P/4PP1P/2P3P1/2P5/1r3PP1/4P2P/1P6 b - - 0 1 (My personal record!)", // 17 (14 targets, score=93)
        "3rPP2/2P5/8/1P2PP2/2PPP3/6P1/1PP5/1P4P1 b - - 0 1 (This is a maze of pawns!)", // 18 (14 targets, score=95)
        "P2P1PP1/4P2P/5P1P/8/6P1/2rP2P1/5P2/P1P2P2 b - - 0 1 (Almost a full army!)", // 19 (15 targets, score=93)
    ...
    "Multi": [ // Section Multi
        ...
        "8/8/4Pr2/1B4R1/8/8/3PP1P1/8 b - - 0 1 (Bishop to rook — a classic combo.)", // 4 (6 targets, score=60)
